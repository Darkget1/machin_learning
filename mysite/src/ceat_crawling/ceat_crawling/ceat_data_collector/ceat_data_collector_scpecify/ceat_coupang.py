...
class coupang_scenario:
    ...
    def coupang_get_link_filter(self, elements, comparison_name, link_comments_cnt_list):
        ...
        if link_ad is None:
            if comparison_name in link_title:
        ...
        for comparison_name in comparison_name_list:
            ...
            if ret is False:
                ...
                while get_link_status is True:
                    link_web_elements = self.scraper.crawler.find_elements('class', 'search-train_data')
                    ...
                    for elements in link_web_elements:
                        # check add link
                        if self.coupang_get_link_filter(elements, comparison_name, link_comments_cnt_list):
